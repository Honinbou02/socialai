...
class SubscriptionController extends Controller
{
    ...
    public function payment($id)
    {
        ...
        $invoice_data = get_option('invoice_data', false);
    ...
    public function success()
    {
        ...
        if ($paymentInfo['status'] == 1) {
            ...
            $user->will_expire = Carbon::now()->addDays((int)$plan->days)->toDateString();
            $user->save();
        }
        ...
        $order->will_expire =  Carbon::now()->addDays((int)$plan->days)->toDateString();
