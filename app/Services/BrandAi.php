...
class BrandAi
{
    ...
    public static function mockAiResponse($type)
    {
        $mockData = [
            ...
            'post' => ['Post cutting-edge technology, Deliver unparalleled customer service, Continuously innovate and improve'],
        ];
    ...
    public function promptResponse($type, $extraData = null, $brandData = false)
    {
        ...
        $res = env('AI_MOCK_DATA', false)
            ? $this->mockAiResponse('post')
            :             $this->aiResponse(
