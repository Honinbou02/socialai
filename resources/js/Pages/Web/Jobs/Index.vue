        ...
        <div class="row justify-content-center">
          <div class="col-xl-12">
            <div class="breadcrumb__content z-index-3 mb-60 text-center">
              <h3 class="breadcrumb__title" v-html="career_header.title"></h3>
      ...
      <div class="row align-items-center">
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="carrer-banner-img-item">
            <img :src="career_header.image1" alt="Career" />
          </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
          <div class="carrer-banner-img-item mb-20">
            <img :src="career_header.image3" alt="Career" />
          </div>
          <div class="carrer-banner-img-item">
            <img :src="career_header.image4" alt="Career" />
          </div>
        </div>
      </div>
    </div>
