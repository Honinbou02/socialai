...
<template>
  <div
    ...
    :style="`background-image:url(${data.bg_image ?? '/assets/img/testimonial/testi-bg-2-1.png'})`"
  >
    <div class="container">
              ...
              >
                ...
                >
                  <div class="tp-testimonial-2-border-shape">
                    <img :src="testimonial.body_img" alt="" />
                  </div>
                  ...
                  <div class="tp-testimonial-2-author d-flex align-items-center">
                    <div class="tp-testimonial-2-img">
                      <img :src="testimonial.image" class="rounded-circle" alt="" />
                    </div>
