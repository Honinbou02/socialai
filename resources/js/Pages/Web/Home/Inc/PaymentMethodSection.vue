  ...
  <div class="tp-payment-method__area tp-payment-method__space">
    <div class="container-fluid g-0">
      <div class="row g-0 justify-content-center">
        <div class="col-xl-7">
          <div class="mb-20 text-center tp-payment-method__title-box">
            <h3 class="pb-10 tp-section-title-lg" v-html="data.title"></h3>
