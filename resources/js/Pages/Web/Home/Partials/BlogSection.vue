...
<template>
  <div class="tp-blog-area pb-80">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-5">
          <div class="text-center tp-blog-section-box mb-50">
            <h3 class="tp-section-title-3">
              {{ trans("Our Latest ") }}<span>{{ trans("News and Articles") }}</span>
            </h3>
          </div>
        </div>
      </div>
      <div class="row">
        <div v-for="blog in blogs" class="col-xl-4 col-lg-4 col-md-6 mb-60">
