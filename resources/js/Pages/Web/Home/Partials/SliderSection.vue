        ...
        <div class="col-xl-11">
          <div class="tp-hero-title-box text-center">
            <h2 ref="hero_text_anim" class="tp-hero-title-3 hero-text-anim pb-5">
              <i><i ref="heroTextAnimChildren" class="child-1" v-html="hero.title"></i></i>
            </h2>
            <p class="tp-char-animation-2">
              {{ hero.subtitle }}
            </p>
          </div>
          <div class="tp-hero-btn-3 wow tpfadeUp text-center" data-wow-duration=".9s" data-wow-delay=".7s">
            <a class="tp-btn-blue-lg tp-btn-hover alt-color-black" :href="hero.btn_one_link">
              <span>{{ hero.btn_one_text }}</span>
              <b></b>
            </a>
            <a class="tp-btn-border tp-btn-hover alt-color-black" :href="hero.btn_two_link">
          ...
          <div class="tp-hero-browser-wrapper d-flex align-items-center justify-content-center wow tpfadeUp"
            ...
            <div v-for="item in hero.icons" class="tp-hero-browser-item">
              <a :href="item.link">
          ...
          <div class="tp-hero-3-wrapper p-relative">
            ...
            <div class="tp-hero-3-main-thumb z-index-5">
              <img :src="hero.bottom_img ?? '/assets/img/hero/hero-img-3-1.png'" alt="" />
            </div>
            <div class="tp-hero-3-shape-5 d-none d-lg-block wow frist-img animated">
              <img :src="hero.bottom_bg_overflow" alt="" />
            </div>
