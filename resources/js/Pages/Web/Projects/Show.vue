    ...
    <div class="container">
      <div class="breadcrumb__content-wrap">
        ...
        <div class="row g-0 z-index-3">
          <div class="mb-40 col-xl-3 col-lg-3 col-md-6 pd-border-right">
          ...
          <div
            class="mb-40 col-xl-3 col-lg-3 col-md-6 pd-border-right"
          ...
          >
            <div class="breadcrumb__client-info space-left-4">
              ...
              <div class="breadcrumb__live-btn">
                <a class="tp-btn-inner-border" :href="project.preview_link"
  ...
  <div class="pd-thumb-area">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="pd-thumb">
            <img :src="project.banner_preview" alt="" />
          </div>
        </div>
      </div>
    </div>
