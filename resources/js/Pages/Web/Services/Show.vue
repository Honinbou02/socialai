        ...
        <div class="col-xl-4 col-lg-4">
          <div class="sv-details-widget">
            ...
            <div
              ...
              :style="{ 'background-image': `url(${sidebar_card.bg_img})` }"
            >
        ...
        <div class="col-xl-8 col-lg-8">
          <div class="sv-details-wrapper">
            <div class="sv-details-thumb mb-45">
              <img class="w-100" :src="service.preview" alt="" />
            </div>

            <div v-html="service.overview"></div>
