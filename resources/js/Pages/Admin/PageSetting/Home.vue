  ...
  <form @submit.prevent="form.submit('home_page', data)">
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      <div class="mb-2">
        ...
        <small
          >Note: use <code>&lt;span&gt;text&lt;/span&gt;</code> to make text
      ...
      <div class="mb-2">
        ...
        <input type="text" class="input" v-model="data.hero.btn_one_link" />
      </div>
      <div class="mb-2">
      ...
      <div class="mb-2">
        ...
        <input type="text" class="input" v-model="data.hero.btn_two_link" />
      </div>
      ...
      <div class="mb-2">
        ...
        >
          <span
            class="rounded-full bg-indigo-600 p-2 py-1 text-center text-white"
            >{{ index + 1 }}</span
          >
      ...
      >
        <div class="mb-2">
          ...
          <input
            type="text"
            class="input"
            v-model="data.counter[`${item}_title`]"
          />
        </div>
        <div class="mb-2">
          ...
          <input
            type="text"
            class="input"
            v-model="data.counter[`${item}_subtitle`]"
          />
        </div>
      </div>
    </div>
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      ...
      <div class="mb-2">
        <label>{{ trans("Right Button Link") }}</label>
        <input type="text" class="input" v-model="data.service.btn_link" />
      </div>
      <ImageInput
        v-model="data.service.bg_img"
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      ...
      <div class="mb-2">
        ...
        <input type="text" class="input" v-model="data.rated.btn_link" />
      </div>

      <ImageInput
        v-model="data.rated.bg_img"
        label="Background Image"
        class="mb-2"
      />
      <ImageInput
        v-model="data.rated.bg_top_left_image"
        label="BG top-left shape"
        class="mb-2"
      />

      <ImageInput
        v-model="data.rated.bg_top_right_image"
        label="BG top-right shape"
        class="mb-2"
      />
      ...
      <div class="mb-2">
        ...
        <button type="button" @click="addReviewItem" class="btn btn-primary">
          +
        </button>
      </div>
    </div>
      ...
      <div class="grid grid-cols-2 gap-2">
        <div>
          <div class="mb-2 flex items-center justify-between">
            ...
            <button
              type="button"
              @click="addIntegrationRowOneItem"
        ...
        <div>
          <div class="mb-2 flex items-center justify-between">
            ...
            <button
              type="button"
              @click="addIntegrationRowTwoItem"
              class="btn btn-primary me-2"
            >
              +
            </button>
    ...
    <div>
      ...
      <div class="mb-2">
        <label>{{ trans("Button Link") }}</label>
        <input type="text" class="input" v-model="data.cta_s3.btn_link" />
      </div>
      ...
      <div class="mb-2">
        ...
        >
          ...
          <button
            type="button"
            @click="removeCta3Item(index)"
            class="btn btn-danger"
          >
            X
          </button>
        </div>
        <button type="button" @click="addCta3Item" class="btn btn-primary">
          +
        </button>
      </div>
      <div class="mb-2">
