...
<template>
  ...
  >
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      ...
      <ImageInput
        :label="trans('Banner Image')"
        v-model="form.hero.banner_img"
        class="mb-2"
      />
    </div>
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      ...
      <div class="mb-2">
        ...
        <input type="text" class="input" v-model="form.service.btn_link" />
      </div>

      <ImageInput
        :label="trans('Background Image')"
        v-model="form.service.bg_img"
        class="mb-2"
      />
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      ...
      <div class="mb-2">
        ...
        <input type="text" class="input" v-model="form.sidebar_card.btn_link" />
      </div>
