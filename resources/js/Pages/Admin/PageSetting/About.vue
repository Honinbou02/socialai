...
<template>
  <form method="POST" @submit.prevent="store.submit('about_page', form)" enctype="multipart/form-data">
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      ...
      <div class="mb-2">
        ...
        <input type="text" class="input" v-model="form.company.demo_video" />
      </div>
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      ...
      <ImageInput :label="trans('Left Bottom Image')" v-model="form.cta_s1.left_bottom" class="mb-2" />
    </div>
    ...
    <div class="mb-10 mt-2 rounded border p-3 dark:border-gray-600">
      ...
      <div class="mb-2">
        ...
        <div class="mb-2 flex items-center gap-x-2 rounded border p-2 dark:border-gray-600"
          v-for="(item, index) in form.timeline.features" :key="index">
