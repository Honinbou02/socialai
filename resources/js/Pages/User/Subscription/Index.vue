...
<template>
  <main class="container flex-grow p-4 sm:p-6">
    ...
    <div class="alert alert-warning text-base" v-else-if="isNearExpiry">
      <p>
        {{ trans('Your current subscription plan is about to expire in some days') }}
      </p>
    </div>
      ...
      <div class="col-span-1 flex gap-3 border-l border-primary-400 p-4 lg:col-span-5 lg:p-8">
        ...
        <div class="px-2">
          <p class="text-primary-500">
            {{ parseInt(user.plan.days) === 30 ? 'Monthly' : parseInt(user.plan.days) === 365 ? 'Yearly' : 'Lifetime' }}
      ...
      <template v-for="plan in filteredPlans" :key="plan.id">
        ...
        >
          ...
          <div class="my-8 flex justify-center gap-2">
            ...
            <span>
              {{ parseInt(plan.days) === 30 ? 'Monthly' : parseInt(plan.days) === 365 ? 'Yearly' : 'Lifetime' }}
            </span>
          </div>
