...
const questions = [
  {
    order: 1,
    text: trans('Welcome to the brand setup! To optimize content for your brand, we need some?')
  },
  { order: 2, text: trans("Firstly, what's the exact name of your brand?") },
  {
    order: 3,
    text: trans('Great! Now, can you provide a detailed description of your brand? Think about the main product or service you offer, who your primary customers are, and what sets you apart from others.')
  },
  {
    order: 4,
    text: trans("A visual identity starts with a logo. If you have a logo, feel free to share it, or we'll begin with a temporary placeholder logo.")
  },
  {
    order: 5,
    text: trans("Are primary and secondary colors already on your mind for your brand? If not, don't worry. We'll generate it for you.")
  },
  {
    order: 6,
    text: trans('What type of brand do you have?')
  },
  {
    order: 7,
    text: trans('Please wait.....')
  }
]
const brandQuotes = [
...
const addUserMessage = (message, isFile = false) => {
  ...
  const validationParams = {
    2: [
      ...
      1,
      10,
      trans("Sorry, Make it a minimum of 1 and a maximum of 10 words. What's the exact name of your brand?")
    ],
    3: [
      'description',
      20,
      100,
      trans('Sorry, Make it a minimum of 20 and a maximum of 100 words. What does your company do? Who are your customers? What are your products or services?')
    ]
  }
    ...
    <div class="m-auto max-w-6xl rounded-2xl border pb-3 shadow-lg dark:border-gray-800">
      ...
      >
        <div class="flex items-center">
          ...
          <h5 class="mr-1">{{ trans('Create New Brand') }}</h5>
        </div>
      </div>
                ...
                <template v-if="orderState(chat, 4)">
                  ...
                  <div v-if="userActions.hasImage" class="w-full border-t border-gray-600 pt-3">
                    ...
                    <button
                      ...
                      "
                    >
                      {{ trans('No, I\'ll use a placeholder for now') }}
                    </button>
                  </div>
                </template>
                <!-- color -->
                <template v-if="orderState(chat, 5)">
                  ...
                  >
                    ...
                    <button
                      ...
                      "
                    >
                      {{ trans('Not now, let AI generate it for me') }}
                    </button>
                  </div>
                  <div v-if="userActions.hasColor" class="w-full border-t border-gray-600 pt-3">
                    <div class="grid grid-cols-2 gap-x-4">
                      <div>
                        <label class="label mb-1">{{ trans('Primary Color') }}</label>
                      ...
                      <div>
                        <label class="label mb-1">{{ trans('Secondary Color') }}</label>
                        <div class="flex items-center gap-x-2">
                          <div class="h-9 w-10 overflow-hidden rounded-md">
                            <input
                    ...
                    <button class="btn btn-primary mt-3" @click="handleUserColor">{{ trans('Save') }}</button>
